...
- **ChatbotModule** (`src/chatbot/`) - chatbot integration (stub)

### Database Layer

- **Prisma schema:** `prisma/schema.prisma` - models: User, Chat, Message (with MessageType enum)
...
See `.example.env`: `PORT`, `DATABASE_URL`, `JWT_SECRET`
